...
export class SessionService {
  ...
  getIsSubmitter() : any {
    return localStorage.getItem("user_type") != null && localStorage.getItem("user_type") == "SUBMITTER";
  }

  getIsPCM() : any {
    return localStorage.getItem("user_type") != null && localStorage.getItem("user_type") == "PCM";
  }

  getIsPCC() : any {
    return localStorage.getItem("user_type") != null && localStorage.getItem("user_type") == "PCC";
  }
